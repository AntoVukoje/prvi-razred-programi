...
#include <math.h>
main(){
    int ucenici,brp=1,ocjena,sum=0,pocjena,pocjenar,bro=0;//puc prosjek ucenika upuc ukupan prosjek ucenika brp broj predmeta bru broj ucenika pocjena prolazna ocjena pr prosjek razreda pocjenar prolazna ocjena razreda bro brojac odlikasa
    char ime;
    ...
    pr=upuc/ucenici;
    pocjenar=round(pr);
    printf("Prosjek razreda je %.2f,zavrsna ocjena razreda je %d\nBroj ucenika koji su prosli sa 5 je %d",pr,pocjenar,bro);
}
